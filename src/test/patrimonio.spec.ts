...
test("PATRIMONIO UPDATE", async () => {
    ...
    // Configura o mock do updatePatrimonio para retornar valores específicos
    ...
    // Executa o método updatePatrimonio do controlador
    await patrimonioController.updatePatrimonio(request as FastifyRequest, reply as FastifyReply);

    // Verifica se o mockUpdatePatrimonio foi chamado corretamente
